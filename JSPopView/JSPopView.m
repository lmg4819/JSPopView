...
#import "JSPopView.h"
#import "JSPopAnimationTool.h"

//三角指示控件的宽度
#define TriangleViewWidth 14


@interface JSPopView ()<CAAnimationDelegate,UIGestureRecognizerDelegate>
...
+ (instancetype)getCurrentPopView{
    ...
    JSPopView *oldPopView = (JSPopView *)[window viewWithTag:popViewTag];
    return oldPopView;
}
...
+ (instancetype)popUpContentView:(UIView *)contentView
                    ...
                    triangleView:(nullable UIView *)triangleView
                       animation:(BOOL)animation{
    UIWindow *window = [UIApplication sharedApplication].keyWindow;
    JSPopView *oldPopView = [self getCurrentPopView];
    JSPopView *newPopView = [[JSPopView alloc] initWithFrame:window.bounds
                                                  direct:direct
                                                  onView:onView
    ...
    newPopView.showAnimation = [JSPopAnimationTool getShowPopAnimationWithType:direct contentView:contentView belowView:nil];
    newPopView.hidenAnimation = [JSPopAnimationTool getHidenPopAnimationWithType:direct contentView:contentView belowView:nil];
...
+ (instancetype)popSideContentView:(UIView *)contentView
    ...
    CABasicAnimation *showAnimation = [JSPopAnimationTool getShowPopAnimationWithType:direction contentView:contentView belowView:nil];
    CABasicAnimation *hidenAnimation = [JSPopAnimationTool getHidenPopAnimationWithType:direction contentView:contentView belowView:nil];
    
    JSPopView *popView =  [self popContentView:contentView showAnimation:showAnimation hidenAnimation:hidenAnimation];
...
+ (instancetype)popSideContentView:(UIView *)contentView
    ...
    CABasicAnimation *showAnimation = [JSPopAnimationTool getShowPopAnimationWithType:direction contentView:contentView belowView:belowView];
    CABasicAnimation *hidenAnimation = [JSPopAnimationTool getHidenPopAnimationWithType:direction contentView:contentView belowView:belowView];
    ...
    JSPopView *oldPopView = (JSPopView *)[belowView.superview viewWithTag:popViewTag];
    JSPopView *newPopView = [[JSPopView alloc] initWithFrame:frame
                                                  direct:direction
                                                  onView:nil
                                             contentView:contentView
                                                  offSet:0
...
- (void)animationPopContainerViewWithOldPopView:(JSPopView *)oldPopView{
    if (oldPopView) {
...
+ (void)hidenPopView{
    if (keyboardShow) {
        ...
        JSPopView *popView = (JSPopView *)[superView viewWithTag:popViewTag];
...
- (UIView *)defaultTriangleView{
    ...
    switch (self.direct) {
        case PopViewDirection_PopUpLeft:
            point1 = CGPointMake(TriangleViewWidth/2, TriangleViewWidth/2);
            point2 = CGPointMake(0, 0);
            point3 = CGPointMake(0, TriangleViewWidth);
            triangleFrame.size = CGSizeMake(TriangleViewWidth/2, TriangleViewWidth);
            break;
        case PopViewDirection_PopUpRight:
            point1 = CGPointMake(0, TriangleViewWidth/2);
            point2 = CGPointMake(TriangleViewWidth/2, TriangleViewWidth);
            point3 = CGPointMake(TriangleViewWidth/2, 0);
            triangleFrame.size = CGSizeMake(TriangleViewWidth/2, TriangleViewWidth);
            break;
        case PopViewDirection_PopUpBottom:
            point1 = CGPointMake(TriangleViewWidth/2, 0);
            point2 = CGPointMake(TriangleViewWidth, TriangleViewWidth/2);
            point3 = CGPointMake(0, TriangleViewWidth/2);
            triangleFrame.size = CGSizeMake(TriangleViewWidth, TriangleViewWidth/2);
            break;
        case PopViewDirection_PopUpTop:
            point1 = CGPointMake(0, 0);
            point2 = CGPointMake(TriangleViewWidth, 0);
            point3 = CGPointMake(TriangleViewWidth/2, TriangleViewWidth/2);
            triangleFrame.size = CGSizeMake(TriangleViewWidth, TriangleViewWidth/2);
            break;
        default:
            break;
