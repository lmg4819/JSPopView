...
- (void)show
{
    ...
    UIButton *closeBtn = [[JSButton alloc]init];
    [closeBtn setImage:[UIImage imageNamed:@"icon_aftersale_delet"] forState:UIControlStateNormal];
    ...
    // Attached to the top most window
        ...
        // On iOS8, just place the dialog in the middle
            ...
            self.closeButton.frame = CGRectMake(CGRectGetMaxX(dialogView.frame)-5, CGRectGetMinY(dialogView.frame)-30, 30, 30);
