        ...
        for (NSInteger section = startSection; section <= endSection; section++) {
            ...
            for (UICollectionViewLayoutAttributes *layoutAttribute in layoutAttributes) {
                ...
                if ([layoutAttribute.representedElementKind isEqualToString:UICollectionElementKindSectionHeader]) {
                    ...
                    NSInteger section = layoutAttribute.indexPath.section;
                    ...
                    CGFloat headerHeight = CGRectGetHeight(layoutAttribute.frame);
                    CGPoint origin = layoutAttribute.frame.origin;
                    origin.y = MIN(
                                   MAX(
                                       contentOffset.y,
